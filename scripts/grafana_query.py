...
INTENT_TABLE: list[Intent] = [
    ...
    Intent(
        ...
        datasource="loki",
        query='{service_namespace="claude-code"} |= "UserPromptSubmit" | json',
    ...
    Intent(
        ...
        datasource="loki",
        query='{service_namespace="claude-code"} |~ "(PreToolUse|PostToolUse)" | json',
    ...
    Intent(
        ...
        datasource="loki",
        query='{service_namespace="claude-code"} |= "PostToolUseFailure" | json',
    ...
    Intent(
        ...
        datasource="loki",
        query='{service_namespace="claude-code"} |= "compaction" | json',
    ...
    Intent(
        ...
        datasource="loki",
        query='{service_namespace="claude-code"} |= "mcp_server_connection" | json',
